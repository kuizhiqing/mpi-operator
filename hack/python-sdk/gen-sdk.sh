...
"${PWD}/bin/openapi-gen" --input-dirs github.com/kuizhiqing/resilient-training-operator/pkg/apis/kubeflow/v2beta1 --output-package github.com/kuizhiqing/resilient-training-operator/pkg/apis/kubeflow/v2beta1 --go-header-file hack/boilerplate/boilerplate.go.txt
...
echo "Generating V2 Python SDK for Kubeflow Resilient Training Operator ..."
...
echo "Kubeflow Resilient Training Operator Python SDK is generated successfully to folder ${SDK_OUTPUT_PATH}/."
