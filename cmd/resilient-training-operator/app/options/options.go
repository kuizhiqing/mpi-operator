...
func (s *ServerOption) AddFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&s.GangSchedulingName, "gang-scheduling", "",
		`Set gang scheduler name if enable gang scheduling. Now Supporting volcano and scheduler-plugins.
                Note: If you set another scheduler name, the resilient-training-operator assumes it's the scheduler-plugins`)
	...
	fs.StringVar(&s.LockName, "lock-name", "resilient-training-operator", "Set locked name to distinct two deployments.")
