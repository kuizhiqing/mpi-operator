...
from resilientjob.configuration import Configuration


class V2beta1ResilientJobSpec(object):
    ...
    def __init__(self, launcher_creation_policy=None, mpi_implementation=None, mpi_replica_specs=None, run_policy=None, slots_per_worker=None, ssh_auth_mount_path=None, local_vars_configuration=None):  # noqa: E501
        """V2beta1ResilientJobSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    def launcher_creation_policy(self):
        """Gets the launcher_creation_policy of this V2beta1ResilientJobSpec.  # noqa: E501
        ...
        :return: The launcher_creation_policy of this V2beta1ResilientJobSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def launcher_creation_policy(self, launcher_creation_policy):
        """Sets the launcher_creation_policy of this V2beta1ResilientJobSpec.

        launcherCreationPolicy if WaitForWorkersReady, the launcher is created only after all workers are in Ready state. Defaults to AtStartup.  # noqa: E501

        :param launcher_creation_policy: The launcher_creation_policy of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    def mpi_implementation(self):
        """Gets the mpi_implementation of this V2beta1ResilientJobSpec.  # noqa: E501

        MPIImplementation is the MPI implementation. Options are \"OpenMPI\" (default), \"Intel\" and \"MPICH\".  # noqa: E501

        :return: The mpi_implementation of this V2beta1ResilientJobSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def mpi_implementation(self, mpi_implementation):
        """Sets the mpi_implementation of this V2beta1ResilientJobSpec.

        MPIImplementation is the MPI implementation. Options are \"OpenMPI\" (default), \"Intel\" and \"MPICH\".  # noqa: E501

        :param mpi_implementation: The mpi_implementation of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    def mpi_replica_specs(self):
        """Gets the mpi_replica_specs of this V2beta1ResilientJobSpec.  # noqa: E501

        MPIReplicaSpecs contains maps from `MPIReplicaType` to `ReplicaSpec` that specify the MPI replicas to run.  # noqa: E501

        :return: The mpi_replica_specs of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    def mpi_replica_specs(self, mpi_replica_specs):
        """Sets the mpi_replica_specs of this V2beta1ResilientJobSpec.

        MPIReplicaSpecs contains maps from `MPIReplicaType` to `ReplicaSpec` that specify the MPI replicas to run.  # noqa: E501

        :param mpi_replica_specs: The mpi_replica_specs of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    @property
    def run_policy(self):
        """Gets the run_policy of this V2beta1ResilientJobSpec.  # noqa: E501


        :return: The run_policy of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    def run_policy(self, run_policy):
        """Sets the run_policy of this V2beta1ResilientJobSpec.


        :param run_policy: The run_policy of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    def slots_per_worker(self):
        """Gets the slots_per_worker of this V2beta1ResilientJobSpec.  # noqa: E501

        Specifies the number of slots per worker used in hostfile. Defaults to 1.  # noqa: E501

        :return: The slots_per_worker of this V2beta1ResilientJobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def slots_per_worker(self, slots_per_worker):
        """Sets the slots_per_worker of this V2beta1ResilientJobSpec.

        Specifies the number of slots per worker used in hostfile. Defaults to 1.  # noqa: E501

        :param slots_per_worker: The slots_per_worker of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    def ssh_auth_mount_path(self):
        """Gets the ssh_auth_mount_path of this V2beta1ResilientJobSpec.  # noqa: E501

        SSHAuthMountPath is the directory where SSH keys are mounted. Defaults to \"/root/.ssh\".  # noqa: E501

        :return: The ssh_auth_mount_path of this V2beta1ResilientJobSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def ssh_auth_mount_path(self, ssh_auth_mount_path):
        """Sets the ssh_auth_mount_path of this V2beta1ResilientJobSpec.

        SSHAuthMountPath is the directory where SSH keys are mounted. Defaults to \"/root/.ssh\".  # noqa: E501

        :param ssh_auth_mount_path: The ssh_auth_mount_path of this V2beta1ResilientJobSpec.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2beta1ResilientJobSpec):
            return False
